  ...
  <body id="bodyColor">
      ...
      <div class="container-fluid">
          ...
          <div id="home" class="main_contents">
              ...
              <div class="col-sm-12">
                  <div id="main_3d_image">
                      <div id="main_text" class="col-xs-12 col-sm-4">
                        ...
                        <div id="subTitle_home">
                          <h3>Founded in 1886 Dr John S Pemberton</h3>
                        </div>
            ...
            <!-- A row to hold three cards for the Coke, Sprite and Fanta contents -->
            <div class="row">
                  <div class="col-sm-4">
                      <div class="card img-narrow">
                          <a href="application/assets/images/renderImages/fanta.jpg" data-fancybox data-caption="My 3D Fanta Can Render">
                            <img style="max-height:252px;" class="card-img-top img-fluid img-thumbnail" src="application/assets/images/fanta.jpg" alt="Fanta">
                          </a>
                          <div class="card-body">
                  ...
                  <div class="col-sm-4">
                      <div class="card img-narrow">
                          <a href="application/assets/images/renderImages/sprite.jpg" data-fancybox data-caption="My 3D Sprite Cup Render" class="thumbnail">
                ...
                <div class="card text-left">
                    ...
                    <div class="card-body">
                        ...
                        <div class="gallery" >
                          ...
                          <img class="coke_gallery" src="application/assets/images/gallery_images/coke1.png" alt="">
                          <img class="coke_gallery" src="application/assets/images/gallery_images/coke2.png" alt="">

                          <img class="sprite_gallery" style='display:none;' src="application/assets/images/gallery_images/sprite1.png" alt="">
                          <img class="sprite_gallery" style='display:none;' src="application/assets/images/gallery_images/sprite2.png" alt="">

                          <img class="fanta_gallery" style='display:none;' src="application/assets/images/gallery_images/fanta1.png" alt="">
                          <img class="fanta_gallery" style='display:none;' src="application/assets/images/gallery_images/fanta2.png" alt="">
                        </div>
      ...
      <!-- JQuery code to get content data from a database -->
